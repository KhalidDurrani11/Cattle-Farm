...
export default function Footer() {
  return (
    <footer className="bg-[#4A2712] text-[#FAF8F5] border-t border-[#2A1508] py-16 px-6 md:px-12 transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-[#2A1508] flex flex-col md:flex-row items-center justify-between gap-4">
